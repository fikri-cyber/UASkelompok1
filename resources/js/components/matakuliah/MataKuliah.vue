        ...
        <div class="col-md-10">
          ...
          <div class="btn-group btn-group-toggle" data-toggle="buttons">
            <label class="btn btn-outline-secondary">
              <input type="radio" name="options" id="option1" checked @click="filterkelas(7)" /> Kelas A
            </label>
            <label class="btn btn-outline-secondary">
              <input type="radio" name="options" id="option2" @click="filterkelas(8)" /> Kelas B
            </label>
            <label class="btn btn-outline-secondary">
              <input type="radio" name="options" id="option3" @click="filterkelas(9)" /> Kelas C
            </label>
          </div>
        </div>
        <div class="col-md-2">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h5
              ...
              id="exampleModalLabel"
              v-show="editmode"
            >Memperbarui Mata Kuliah Baru</h5>
