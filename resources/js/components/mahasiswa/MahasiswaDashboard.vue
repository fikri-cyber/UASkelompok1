          ...
          <div class="col-md-10">
            ...
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
              <label class="btn btn-outline-secondary">
                <input type="radio" name="options" id="option1" checked @click="filterkelas(A)" /> Kelas A
              </label>
              <label class="btn btn-outline-secondary">
                <input type="radio" name="options" id="option2" @click="filterkelas(B)" /> Kelas B
              </label>
              <label class="btn btn-outline-secondary">
                <input type="radio" name="options" id="option3" @click="filterkelas(C)" /> Kelas C
              </label>
            </div>
          </div>
          <div class="col-md-2">
