        ...
        <nav class="navbar navbar-expand-md bg-blue">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav geserkanan">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://poltektedc.ac.id/new/"><i class="fa fa-info"></i> Tentang TEDC</a>
                    </li>
                    <li class="nav-item">
...
<div class="kotakputih">
            <div class="isikotakputih">
                ...
                <hr>
                <p>Sistem Informasi Akademik Politeknik TEDC Bandung adalah portal akademik bagi civitas Politeknik TEDC Bandung. Jika terdapat masalah atau kendala dalam penggunaan Sistem Informasi Akademik SCB, silakan baca FAQ (Frequently Asked Questions).
                </p>
            </div>
        </div>
    </div>
    ...
    <footer class="footer mt-auto ">
        ...
        <p>
            ...
            Copyright © Politeknik TEDC Bandung 2021
        </p>
        <p>

            Jl. Politeknik No.2 Cibabat-Cimahi Utara.
        </p>
        </div>
    </footer>
